...
struct tag_descriptor {
	...
	int	(* arith_op[44 ]) (... )  ;
	int	(* coerce_to[14 +1]) (value,value*)  ;
};
...
extern "C"  t_eclipse_data	*_imp__ec_;


extern "C"  t_ext_type		*_imp__ec_xt_double_arr;


extern "C"  t_ext_type		*_imp__ec_xt_long_arr;


extern "C"  t_ext_type		*_imp__ec_xt_char_arr;
...
extern "C"  void	Winapi	ec_post_string  (const char *)  ;
extern "C"  void	Winapi	ec_post_exdr  (int, const char *)  ;
extern "C"  int	Winapi	ec_resume  (void)  ;
extern "C"  int	Winapi	ec_resume1  (ec_ref)  ;
extern "C"  int	Winapi	ec_resume2  (const pword,ec_ref)  ;
extern "C"  int	Winapi	ec_resume_long  (long *)  ;
extern "C"  int	Winapi	ec_resume_async  (void)  ;
extern "C"  int	Winapi	ec_running  (void)  ;
extern "C"  int	Winapi	ec_resume_status  (void)  ;
...
extern "C"  int	Winapi	ec_post_event  (pword)  ;
extern "C"  int	Winapi	ec_post_event_string  (const char *)  ;
...
extern "C"  pword	Winapi	ec_length_string  (int, const char*)  ;
extern "C"  pword	Winapi	ec_atom  (const dident)  ;
extern "C"  pword	Winapi	ec_long  (const long)  ;
...
extern "C"  pword	Winapi	ec_listofrefs  (ec_refs)  ;
extern "C"  pword	Winapi	ec_listofdouble  (int, const double*)  ;
extern "C"  pword	Winapi	ec_listoflong  (int, const long*)  ;
extern "C"  pword	Winapi	ec_listofchar  (int, const char*)  ;
extern "C"  pword	Winapi	ec_arrayofdouble  (int, const double*)  ;
extern "C"  pword	Winapi	ec_matrixofdouble  (int, int, const double*)  ;
extern "C"  pword	Winapi	ec_handle  (const t_ext_type*,const t_ext_ptr)  ;
extern "C"  pword	Winapi	ec_newvar  (void)  ;
...
extern "C"  int	Winapi	ec_get_string_length  (const pword,char**,long*)  ;
extern "C"  int	Winapi	ec_get_atom  (const pword,dident*)  ;
extern "C"  int	Winapi	ec_get_long  (const pword,long*)  ;
extern "C"  int	Winapi	ec_get_double  (const pword,double*)  ;
extern "C"  int	Winapi	ec_get_nil  (const pword)  ;
extern "C"  int	Winapi	ec_get_list  (const pword,pword*,pword*)  ;
extern "C"  int	Winapi	ec_get_functor  (const pword,dident*)  ;
extern "C"  int	Winapi	ec_arity  (const pword)  ;
extern "C"  int	Winapi	ec_get_arg  (const int,pword,pword*)  ;
extern "C"  int	Winapi	ec_get_handle  (const pword,const t_ext_type*,t_ext_ptr*)  ;
extern "C"  int	Winapi	ec_is_var  (const pword)  ;
...
extern "C"  ec_refs	Winapi	ec_refs_create  (int,const pword)  ;
extern "C"  ec_refs	Winapi	ec_refs_create_newvars  (int)  ;
extern "C"  void	Winapi	ec_refs_destroy  (ec_refs)  ;
extern "C"  void	Winapi	ec_refs_set  (ec_refs,int,const pword)  ;
extern "C"  pword	Winapi	ec_refs_get  (const ec_refs,int)  ;
extern "C"  int	Winapi	ec_refs_size  (const ec_refs)  ;

extern "C"  ec_ref	Winapi	ec_ref_create  (pword)  ;
extern "C"  ec_ref	Winapi	ec_ref_create_newvar  (void)  ;
extern "C"  void	Winapi	ec_ref_destroy  (ec_ref)  ;
extern "C"  void	Winapi	ec_ref_set  (ec_ref,const pword)  ;
...
extern "C"  pword	Winapi	ec_arg  (int)  ;
extern "C"  int	Winapi	ec_unify  (pword,pword)  ;
extern "C"  int	Winapi	ec_unify_arg  (int,pword)  ;
extern "C"  int	Winapi	ec_compare  (pword,pword)  ;
extern "C"  int	Winapi	ec_visible_procedure  (dident,pword,void**)  ;
extern "C"  int	Winapi	ec_make_suspension  (pword,int,void*,pword*)  ;
...
extern "C"  int	Winapi	ec_stream_nr  (char *name)  ;
extern "C"  int	Winapi	ec_queue_write  (int stream, char *data, int size)  ;
extern "C"  int	Winapi	ec_queue_read  (int stream, char *data, int size)  ;
extern "C"  int	Winapi	ec_queue_avail  (int stream)  ;
extern "C"  void	Winapi	ec_double_xdr  (double * d, char * dest)  ;
extern "C"  void	Winapi	ec_int32_xdr  (int32 * l, char * dest)  ;
...
__inline  EC_word::EC_word(const EC_ref& ref)
{
