...
:- op(700, xfy, =<+).
:- op(700, xfy, =<*).
ground(_560) :- not nonground(_560).
start(_597) :- =<*(0, =<*(_597, 0)).
=<+(A, B) :-
	'CHRgen_num'(C),
...
:- current_macro('CHR=<+_2' / 4, _1890, _1891, _1892) -> true ; define_macro('CHR=<+_2' / 4, tr_chr / 2, [write]).
'CHR=<+_2__0'(A, B, C, D) :-
	'CHR=<+_2__1'(A, B, C, D).
...
'CHR=<*_2'(=<*(A, B), C, D, E) :-
	'CHR=<*_2__6'(=<*(A, B), C, D, E).
:- set_flag('CHR=<*_2' / 4, leash, notrace).
:- current_macro('CHR=<*_2' / 4, _4182, _4183, _4184) -> true ; define_macro('CHR=<*_2' / 4, tr_chr / 2, [write]).
'CHR=<*_2__6'(A, B, C, D) :-
	'CHR=<*_2__7'(A, B, C, D).
