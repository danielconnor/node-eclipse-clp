...
ground(_511) :- not nonground(_511).
:- op(700, xfx, lss).
:- op(700, xfx, grt).
:- op(700, xfx, neq).
:- op(700, xfx, geq).
:- op(700, xfx, leq).
geq(_673, _674) :- leq(_674, _673).
grt(_691, _692) :- lss(_692, _691).
...
:- current_macro('CHRleq_2' / 4, _10003, _10004, _10005) -> true ; define_macro('CHRleq_2' / 4, tr_chr / 2, [write]).
'CHRleq_2__0'(A, B, C, D) :-
	'CHRleq_2__6'(A, B, C, D).
...
:- current_macro('CHRlss_2' / 4, _15737, _15738, _15739) -> true ; define_macro('CHRlss_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRneq_2' / 4, _25398, _25399, _25400) -> true ; define_macro('CHRneq_2' / 4, tr_chr / 2, [write]).
...
:- current_macro(clause_minimum / 3, _26318, _26319, _26320) -> true ; define_macro(clause_minimum / 3, tr_chr / 2, [write]).
minimum(A, B, C) :-
	'CHRgen_num'(D),
...
:- current_macro('CHRminimum_3' / 4, _30091, _30092, _30093) -> true ; define_macro('CHRminimum_3' / 4, tr_chr / 2, [write]).
'CHRminimum_3__56'(minimum(A, B, C), D, E, F) ?-
	'CHRvar'(D),
...
:- current_macro(clause_maximum / 3, _31917, _31918, _31919) -> true ; define_macro(clause_maximum / 3, tr_chr / 2, [write]).
maximum(A, B, C) :-
	'CHRgen_num'(D),
...
:- current_macro('CHRmaximum_3' / 4, _35690, _35691, _35692) -> true ; define_macro('CHRmaximum_3' / 4, tr_chr / 2, [write]).
'CHRmaximum_3__69'(maximum(A, B, C), D, E, F) ?-
	'CHRvar'(D),
