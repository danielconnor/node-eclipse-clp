...
globalize(_555) :- suspend(true, 2, _555 - _544 -> inst), _544 = fired.
path1(1, _666, _665, [_664], p - p, _674) :- check_pp(_666, _665, _664).
path1(1, _696, _695, [_694], p - i, _704) :- check_pi(_696, _695, _694).
path1(1, _725, _726, [_724], i - p, _734) :- check_ip(_726, _725, _724).
path1(1, _756, _755, [_754], i - i, _764) :- check_ii(_756, _755, _754).
ground(_784) :- not nonground(_784).
...
:- current_macro('CHRarc_4' / 4, _3156, _3157, _3158) -> true ; define_macro('CHRarc_4' / 4, tr_chr / 2, [write]).
'CHRarc_4__0'(A, B, C, D) :-
	'CHRarc_4__1'(A, B, C, D).
...
clause_path(A, B, C, D, E, F) :-
	member(G, D),
	path(1, B, C, [G], E, F).
:- current_macro(clause_path / 6, _3519, _3520, _3521) -> true ; define_macro(clause_path / 6, tr_chr / 2, [write]).
path(A, B, C, D, E, F) :-
	'CHRgen_num'(G),
...
:- current_macro('CHRpath_6' / 4, _5265, _5266, _5267) -> true ; define_macro('CHRpath_6' / 4, tr_chr / 2, [write]).
