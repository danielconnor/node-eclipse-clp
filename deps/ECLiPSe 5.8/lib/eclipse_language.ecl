...
% Version:	$Id: eclipse_language.ecl,v 1.67 2004/11/29 22:40:17 js10 Exp $
...
:- reexport struct(suspend with []) from sepia_kernel.
...
:- autoload(lists, [
	flatten/2, intersection/3, subset/2, union/3]).
